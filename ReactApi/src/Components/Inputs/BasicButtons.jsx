...
export const DashBoardBtn = ({ onclick, value, name, text, Icon,path }) => {
  ...
  return (
    <div className='pl-1 flex justify-start pt-3 cursor-pointer hover:text-black hover:border-2  hover:shadow-2xl rounded-md rounded-r-none ' onClick={()=>navigate(path)}>
